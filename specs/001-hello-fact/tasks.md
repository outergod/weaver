...
- [ ] T038 [P] [US1] Scenario test: `(empty fact-space, [Event::BufferEdited(EntityRef(1))]) → asserts Fact(buffer/dirty=true) on EntityRef(1) with non-empty Provenance` in `core/tests/behavior/dirty_tracking_assert.rs`
